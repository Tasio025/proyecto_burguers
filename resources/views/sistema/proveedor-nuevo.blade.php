...
<div class="panel-body">
      <form id="form1" method="POST" action="/admin/proveedor/nuevo">
            <div class="row">
                  ...
                  <input type="hidden" id="idproveedor" name="idproveedor" class="form-control" value="{{$globalId}}" required>
            ...
            <div class="row">
                  <div class="form-group col-lg-6">
                    ...
                    <input type="number" id="txtTelefono" name="txtTelefono" class="form-control" value="{{$proveedor->telefono ?? ''}}" required>
                  </div>
                  <div class="form-group col-lg-6">
